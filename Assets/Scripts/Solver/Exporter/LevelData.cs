...
namespace Solver.Exporter
{
    public class LevelData
    {
        ...
        public LevelData(
            ...
            int suitCount,
            int calc,
            List<int> collectionSteps,
            List<(int, int, int, bool)> history
        )
        {
            _id = id;
        ...
        {
            return $"{_id},{_seed},{_calc},{_difficulty},{_step1},{_step2},{_step3},{_step4},{_step5},{_step6},{_step7},{_step8},{_suitCount},{_history}";
        }
    }
}
