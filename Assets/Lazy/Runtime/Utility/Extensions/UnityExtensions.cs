...
namespace Lazy.Utility
{
    public static class UnityExtensions
    {
        ...
        public static Image SetVisible(this Image selfObj, bool visible)
        {
            selfObj.gameObject.SetVisible(visible);
            return selfObj;
        }

        public static TMP_Text SetVisible(this TMP_Text selfObj, bool visible)
        {
            selfObj.gameObject.SetVisible(visible);
            return selfObj;
        }

        public static RectTransform SetVisible(this RectTransform selfObj, bool visible)
        {
            selfObj.gameObject.SetVisible(visible);
            return selfObj;
        }

        public static MonoBehaviour SetVisible(this MonoBehaviour selfObj, bool visible)
        {
            selfObj.gameObject.SetVisible(visible);
            return selfObj;
        }
