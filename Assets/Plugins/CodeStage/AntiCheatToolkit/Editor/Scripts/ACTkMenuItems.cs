...
namespace CodeStage.AntiCheat.EditorCode
{
    ...
    internal static class ACTkMenuItems
    {
        ...
        [MenuItem(
            ACTkEditorConstants.ToolsMenuPath + "Injection Detector Whitelist Editor...",
            false,
            1000
        )]
        ...
        [MenuItem(
            ACTkEditorConstants.ToolsMenuPath + "Calculate external build hashes",
            false,
            1200
        )]
        ...
        {
            var buildHashes =
                await CodeHashGeneratorPostprocessor.CalculateExternalBuildHashesAsync(null, true);
            if (buildHashes == null || buildHashes.FileHashes.Count == 0)
            {
                Debug.LogError(
                    ACTk.LogPrefix
                        + "External build hashing was not successful. "
        ...
        [MenuItem(
            ACTkEditorConstants.ToolsMenuPath + "Migrate/Migrate obscured types on prefabs...",
            false,
            1500
        )]
        private static void MigrateObscuredTypesOnPrefabs()
        {
            MigrateUtils.MigrateObscuredTypesOnPrefabs(
                "ObscuredFloat",
                "ObscuredDouble",
                "ObscuredVector2",
                "ObscuredVector3",
        ...
        [MenuItem(
            ACTkEditorConstants.ToolsMenuPath
                + "Migrate/Migrate obscured types in opened scene(s)...",
            false,
            1501
        )]
        private static void MigrateObscuredTypesInScene()
        {
            MigrateUtils.MigrateObscuredTypesInScene(
                "ObscuredFloat",
                "ObscuredDouble",
                "ObscuredVector2",
                "ObscuredVector3",
        ...
        [MenuItem(
            ACTkEditorConstants.ToolsMenuPath + "Validate/Validate obscured types in assets...",
            false,
            1500
        )]
        ...
        [MenuItem(
            ACTkEditorConstants.ToolsMenuPath
                + "Validate/Validate obscured types in opened scene(s)...",
            false,
            1501
        )]
        ...
        [MenuItem(
            ACTkEditorConstants.GameObjectMenuPath + InjectionDetector.ComponentName,
            false,
            1
        )]
        ...
        [MenuItem(
            ACTkEditorConstants.GameObjectMenuPath + ObscuredCheatingDetector.ComponentName,
            false,
            1
        )]
        ...
        [MenuItem(
            ACTkEditorConstants.GameObjectMenuPath + SpeedHackDetector.ComponentName,
            false,
            1
        )]
        ...
        [MenuItem(
            ACTkEditorConstants.GameObjectMenuPath + WallHackDetector.ComponentName,
            false,
            1
        )]
        ...
        [MenuItem(
            ACTkEditorConstants.GameObjectMenuPath + TimeCheatingDetector.ComponentName,
            false,
            1
        )]
