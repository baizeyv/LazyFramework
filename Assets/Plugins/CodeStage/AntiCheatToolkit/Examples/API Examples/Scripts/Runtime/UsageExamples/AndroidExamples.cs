...
namespace CodeStage.AntiCheat.Examples
{
    internal partial class AndroidExamples : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            {
                IsScreenRecordingAllowed = ObscuredPrefs.Get(
                    nameof(IsScreenRecordingAllowed),
                    true
                );
        ...
        private AppInstallationSource GetAndroidInstallationSource()
        {
            ...
            {
                Debug.Log(
                    $"Installed from: {installationSource.DetectedSource} (package name: {installationSource.PackageName})"
                );
