    ...
    internal class ObscuredPerformanceTests : MonoBehaviour
    {
        ...
        private void TestBool()
        {
            logBuilder.AppendLine(
                "ObscuredBool vs bool, " + boolIterations + " iterations for read and write"
            );
        ...
        {
            logBuilder.AppendLine(
                "ObscuredByte vs byte, " + byteIterations + " iterations for read and write"
            );
        ...
        {
            logBuilder.AppendLine(
                "ObscuredShort vs short, " + shortIterations + " iterations for read and write"
            );
        ...
        {
            logBuilder.AppendLine(
                "ObscuredUShort vs ushort, " + ushortIterations + " iterations for read and write"
            );
        ...
        {
            logBuilder.AppendLine(
                "ObscuredDouble vs double, " + doubleIterations + " iterations for read and write"
            );
        ...
        {
            logBuilder.AppendLine(
                "ObscuredFloat vs float, " + floatIterations + " iterations for read and write"
            );
        ...
        {
            logBuilder.AppendLine(
                "ObscuredBigInteger vs BigInteger, "
                    + bigIntIterations
                    + " iterations for read and write"
            );
        ...
        {
            logBuilder.AppendLine(
                "ObscuredLong vs long, " + longIterations + " iterations for read and write"
            );
        ...
        {
            logBuilder.AppendLine(
                "ObscuredInt vs int, " + intIterations + " iterations for read and write"
            );
        ...
        {
            logBuilder.AppendLine(
                "ObscuredString vs string, " + stringIterations + " iterations for read and write"
            );
        ...
        {
            logBuilder.AppendLine(
                "ObscuredUInt vs uint, " + uintIterations + " iterations for read and write"
            );
