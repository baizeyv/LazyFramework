...
namespace CodeStage.AntiCheat.Genuine.CodeHash
{
    internal class StandaloneWindowsWorker : BaseWorker
    {
        ...
        public static BuildHashes GetBuildHashes(
            string buildPath,
        ...
        )
        {
            ...
            var options = new ParallelOptions { MaxDegreeOfParallelism = numCores };
                ...
                (filePath, state) =>
                {
                    ...
                    catch (Exception e)
                    {
                        ACTk.PrintExceptionForSupport(
                            $"Something went wrong while calculating {filePath} hash in {buildPath}!",
                            e
                        );
                    }
                    finally
        ...
        public StandaloneWindowsWorker(int threadsCount)
            : base(threadsCount) { }
