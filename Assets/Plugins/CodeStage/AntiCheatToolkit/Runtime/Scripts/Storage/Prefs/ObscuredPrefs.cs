...
namespace CodeStage.AntiCheat.Storage
{
    ...
    public static partial class ObscuredPrefs
    {
        ...
        [Obsolete(
            "Custom crypto key is now obsolete, use only for data recovery from prefs saved with previous version. "
        ...
        [Obsolete(
            "Please use DeviceLockSettings.DeviceLockTamperingSensitivity property instead.",
            false
        )]
        public static bool readForeignSaves
        {
            ...
            set =>
                DeviceLockSettings.Sensitivity = value
                    ? DeviceLockTamperingSensitivity.Low
                    : DeviceLockTamperingSensitivity.Normal;
        }
        ...
        public static bool emergencyMode
        {
            ...
            set =>
                DeviceLockSettings.Sensitivity = value
                    ? DeviceLockTamperingSensitivity.Disabled
                    : DeviceLockTamperingSensitivity.Normal;
        }
        ...
        public static bool GetRawValue(
            string key,
...
#if UNITY_WEBGL
                Debug.LogError(
                    $"{LogPrefix}Couldn't save PlayerPrefs, looks like WebGL PlayerPrefs size exceeds 1 MB limit!"
                );
#endif
        ...
        public static void Set<T>(string key, T value)
        {
            if (key == null)
                throw new ArgumentNullException(
                    nameof(key),
                    $"{LogPrefix}You've passed null as key for type {typeof(T)}!"
                );

            if (value == null)
                throw new ArgumentNullException(
                    nameof(value),
                    $"{LogPrefix}You've passed null as value for type {typeof(T)}!"
                );
...
#if UNITY_WEBGL
                Debug.LogError(
                    $"{LogPrefix}Couldn't write PlayerPrefs value, looks like WebGL PlayerPrefs size exceeds 1 MB limit!"
                );
#endif
                Debug.LogException(e);
            }
...
#pragma warning disable 618
            if (
                (NotGenuineDataDetected != null || OnAlterationDetected != null)
                && !alterationReported
            )
            {
...
#pragma warning disable 618
            if (
                (DataFromAnotherDeviceDetected != null || OnPossibleForeignSavesDetected != null)
                && !foreignSavesReported
            )
            {
