...
#pragma warning restore 414
        ...
        public static long MigrateEncrypted(
            long encrypted,
            byte fromVersion = 0,
            byte toVersion = 2
        )
        ...
        private struct DoubleLongBytesUnion
        {
            ...
            [FieldOffset(0)]
            internal long l; // need to be internal for ACTK_OBSCURED_AUTO_MIGRATION

            [FieldOffset(0)]
            internal ACTkByte8 b8; // need to be internal for ACTK_OBSCURED_AUTO_MIGRATION
