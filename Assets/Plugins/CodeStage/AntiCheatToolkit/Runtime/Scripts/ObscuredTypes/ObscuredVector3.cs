...
namespace CodeStage.AntiCheat.ObscuredTypes
{
    ...
    public partial struct ObscuredVector3 : IObscuredType
    {
        ...
        [SerializeField]
        internal RawEncryptedVector3 hiddenValue;
                ...
                switch (index)
                {
                    ...
                    default:
                        throw new IndexOutOfRangeException(
                            $"Invalid {nameof(ObscuredVector3)} index!"
                        );
                }
            }
            set
        ...
        private static bool Compare(float f1, float f2)
        {
            var epsilon = ObscuredCheatingDetector.ExistsAndIsRunning
                ? ObscuredCheatingDetector.Instance.vector3Epsilon
                : float.Epsilon;
