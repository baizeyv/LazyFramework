...
#pragma warning restore 0649
        ...
        [SerializeField]
        internal char[] cryptoKey;

        [SerializeField]
        internal char[] hiddenChars;

        [SerializeField]
        internal string fakeValue;
        ...
        internal static char[] InternalEncryptDecrypt(char[] value, char[] key)
        {
            ...
            {
                Debug.LogError(
                    ACTk.LogPrefix + "Empty key can't be used for string encryption or decryption!"
                );
                return value;
            }
        ...
        private char[] InternalDecrypt()
        {
            ...
            if (
                ...
                && fakeValueActive
                && !Compare(decrypted, fakeValue)
            )
            {
#if ACTK_DETECTION_BACKLOGS
                Debug.LogWarning(
                    ObscuredCheatingDetector.LogPrefix
                        + "Detection backlog:\n"
        ...
        {
            var decryptedOld = EncryptDecryptObsolete(
        ...
        [Obsolete(
            "This API is redundant and does not perform any actions. It will be removed in future updates."
        )]
        ...
        [Obsolete(
            "Please use new Encrypt(value, key) or Decrypt(value, key) APIs instead. "
