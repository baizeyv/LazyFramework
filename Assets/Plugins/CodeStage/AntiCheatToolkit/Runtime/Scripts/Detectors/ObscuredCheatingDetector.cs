...
namespace CodeStage.AntiCheat.Detectors
{
    ...
    [HelpURL(
        ACTk.DocsRootUrl
            + "class_code_stage_1_1_anti_cheat_1_1_detectors_1_1_obscured_cheating_detector.html"
    )]
    public class ObscuredCheatingDetector : ACTkDetectorBase<ObscuredCheatingDetector>
    {
        ...
        public void TriggerDetection()
        {
            ...
            LastDetectionInfo = new ObscuredCheatingDetectionInfo(
                typeof(ObscuredString),
                "This is an example of encrypted string.",
                "This is an example of modified string."
            );
            OnCheatingDetected();
        }
